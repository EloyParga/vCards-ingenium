...
//             if (divs[i].getBoundingClientRect().bottom <= window.innerHeight) {
//                 divs[i].classList.remove('active');
//                 divs[i + 1].classList.add('active');
//             }
//         }
//     } else {
//         // Scroll hacia arriba
//         for (let i = divs.length - 1; i > 0; i--) {
//             if (divs[i].getBoundingClientRect().top >= 0) {
//                 divs[i].classList.remove('active');
//                 divs[i - 1].classList.add('active');
//             }
//         }
//     }
//     lastScrollTop = st <= 0 ? 0 : st; // Para manejar el scroll cuando llega al tope de la página
// });
